...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="btn btn-warning btn-block" href="empleados.jsp">Ingresar Empleado</a>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="../sr_puestos" method="post" class="form-group">
                                ...
                                <input type="text" name="txt_puesto" id="txt_puesto" class="form-control" placeholder="puesto1" required>
